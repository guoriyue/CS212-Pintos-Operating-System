...
//   printf("start add_timer_sleep_thread_to_blocked_list\n");
//   ASSERT (!intr_context ());
//   ASSERT (intr_get_level () == INTR_OFF);
//   struct thread * t= thread_current ();
//   list_push_back (&blocked_list, &t->elem);
//   // thread_current ()->status = THREAD_BLOCKED;
//   printf("end add_timer_sleep_thread_to_blocked_list\n");
// }
...
// {
//   printf("start thread_donate_priority\n");
